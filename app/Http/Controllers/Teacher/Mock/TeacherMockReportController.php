...
class TeacherMockReportController extends Controller
{
    //index
    public function index(){
        $schoolTerm = TermAndAcademicYear();
        $data = [] ?? null;
        return view('teacher.dashboard.report.mock.index', compact('schoolTerm', 'data'));
    }
...
//        $output = '';
//        //get term details
//        $termData = Term::where('school_id', Auth::guard('teacher')->user()->school_id)->where('is_active', 1)
//->first();
//        //mock first entry
//        $mockFirstEntry = StudentMock::where('mock_id', $mock_id)
//            ->where('student_id', $student)
...
//                'schoolProfile' => $schoolProfile,
//            ];
//            $pdf = Pdf::loadView("teacher.dashboard.report.mock.StudentMockReportDownload");
//        }
//        else{
//            $data = [
...
//            $pdf = Pdf::loadView("teacher.dashboard.report.mock.StudentMockReportDownload");
//        }
        $pdf = Pdf::loadView("teacher.dashboard.report.mock.StudentMockReportDownload", $data)->setOption(['defaultFont' =>
            'sans-serif']);
