...
namespace App\Http\Controllers\Admin\Subjects\AssignSubjectToLevel;
...
class AssignSubjectToLevelController extends Controller
{
    //index
    ...
    //     return view("admin.dashboard.subject.assignSubjectToLevel.add");
    // }
    ...
    public function create(){
        ...
        $levels = Level::all();
       return view("admin.dashboard.subject.assignSubjectToLevel.add",compact('schoolTerm', 'subjects', 'levels'));
    }
