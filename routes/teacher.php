...
Route::middleware(['auth' => 'teacher'])->controller(TeacherUserController::class)->group(function (){
    ...
    Route::get('assessment/getStudentsBasedOnLevel', [TeacherMockController::class, 'getStudentsBasedOnLevel'])->name
    ('getTeacherStudentsBasedOnLevel');
    ...
    Route::get("assessment/end-of-term/get-student-to-end-term", [TeacherEndOfTermController::class, 'create'])->name
    ("get-teacher-student-to-end-term");
    Route::post("assessment/end-of-term/new-student-end-term-entry", [TeacherEndOfTermController::class, 'store'])->name
    ("new-teacher-student-end-term-entry");
    ...
    Route::post("report/mock/download", [TeacherMockReportController::class, 'download_mock_report'])->name
    ('download_mock_report');

    /**MidTerm Report**/
    Route::get('report/mid-term', [TeacherMidTermReportController::class, 'index'])->name('teacher_mid_term_report');
    Route::post('report/mid-term/view', [TeacherMidTermReportController::class, 'preview_mid_term_report'])->name
    ('preview_mid_term_report');
    Route::post('report/mid-term/download', [TeacherMidTermReportController::class, 'download_mid_term_report'])->name
    ('download_mid_term_report');
