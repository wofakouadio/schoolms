...
{{--            @if(empty($schoolData['media']['school_logo']) ?? $schoolData['school_logo'] === 'profile.png' ?? null)--}}
...
{{--            <img src="{{$schoolData['media'][0]->getUrl()}}" alt="profile" class="rounded" width="62.074" height="65.771" viewBox="0 0 62.074 65.771">--}}
{{--        @endif--}}
...
{{--                </text>--}}
{{--                <p class="Job_Admin_Dashboard text-primary"></p>--}}
