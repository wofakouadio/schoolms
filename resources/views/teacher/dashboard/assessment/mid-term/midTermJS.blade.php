 <script>
    $(document).ready(()=> {
        ...
        $("#new-student-mid-term-form").on("submit", (e)=>{
            ...
            $.ajax({
                url:'{{route('get-teacher-student-to-mid-term')}}',
                method:'GET',
                cache: false,
                data: form,
                success:(Response)=>{
                    ...
                    modal.find('input[name=academic_year]').val(Response['Term']['academic_year']['academic_year_start']+'/'+Response['Term']['academic_year' +
                    '']['academic_year_end'])
