                                ...
                                <div class="auth-form">
                                    <div class="text-center mb-3">
                                        {{-- <a href="index.html" class="brand-logo">
                                            <svg class="logo-abbr me-1" xmlns="http://www.w3.org/2000/svg" width="62.074"
                                                height="65.771" viewBox="0 0 62.074 65.771">
                                                <g id="search_11_" data-name="search (11)"
                                                    transform="translate(12.731 12.199)">
                                                    <rect class="rect-primary-rect" id="Rectangle_1" data-name="Rectangle 1"
                                                    ...
                                                    <path id="Path_2001" data-name="Path 2001"
                                                        ...
                                                        transform="translate(1 0)" fill="#fff" stroke="#fff"
                                                        stroke-width="1" />
                                                    <path id="Path_2002" data-name="Path 2002"
                                                        ...
                                                        transform="translate(-168.591 -98.178)" fill="#fff"
                                            ...
                                            <svg class="brand-title" xmlns="http://www.w3.org/2000/svg" width="134.01"
                                                height="48.365" viewBox="0 0 134.01 48.365">
                                                <g id="Group_38" data-name="Group 38"
                                                    transform="translate(-133.99 -40.635)">
                                    ...
                                    <div class="row justify-content-center h-100 align-items-center mt-5">
                                        <div class="col-xl-6 col-md-6">
                                            <a class="btn btn-primary text-center" href="{{route('onBoarding')}}">
                                        ...
                                        <div class="col-xl-6 col-md-6">
                                            <a class="btn btn-primary" href="{{route('platform')}}">
                                                <span class="btn-icon-start text-primary">
