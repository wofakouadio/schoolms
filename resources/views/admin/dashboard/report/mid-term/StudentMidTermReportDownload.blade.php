...
{{--                    </div>--}}
                    @foreach($data as $value)
                        <table  style="width: 100%; align-self: center;">
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    "><b>{{$value['midTermData']}} Mid-Term Performance Summary</b></p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table style="width: 100%; border: 1px solid black; text-align: center">
                            ...
                            <tr style="text-align: center; border: 1px solid black">
                                <td style="border: 1px solid black; text-align: left;
                                padding-left:10px">Mid-Term:</td>
                                <td style="border: 1px solid black; text-align: left;
                                padding-left:10px">{{$value['midTermData']}}</td>
                                <td style="border: 1px solid black; text-align: left;
                                padding-left:10px">Total Score:</td>
                                <td style="border: 1px solid black; text-align: left;
                                padding-left:10px">{{$value['midTermFirst']['total_score']}}</td>
                            </tr>
                        </table>
