{{--Create new mock setup--}}
<div class="modal fade" id="new-mock-setup-modal">
    <form method="post" id="new-mock-setup-form">
        @csrf
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">New Mock Setup</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12 mb-4">
                            <label  class="form-label font-w600">Type<span class="text-danger scale5
                            ms-2">*</span></label>
                            <input type="text" name="mock_type" value="{{old('mock_type')}}" class="form-control
                            solid">
                        </div>
                    </div>
                </div>
...
{{--Edit mock setup--}}
<div class="modal fade" id="edit-mock-setup-modal">
    <form method="post" id="update-mock-setup-form">
        @csrf
        @method('PUT')
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Update Mock Setup</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12 mb-4">
                            <label  class="form-label font-w600">Type<span class="text-danger scale5
                            ms-2">*</span></label>
                            <input type="text" name="mock_type" value="{{old('mock_type')}}" class="form-control solid">
...
{{--delete mock setup--}}
<div class="modal fade" id="delete-mock-setup-modal">
    <form method="post" id="delete-mock-setup-form">
        @csrf
        @method('DELETE')
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Delete Mock Setup</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <div class="modal-body">
...
<div class="modal fade" id="assign-subjects-to-mock-modal">
    <form method="post" id="assign-subjects-to-mock-form">
        @csrf
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Assign Subjects to Mock</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12 mb-4">
                            <label  class="form-label font-w600">Type<span class="text-danger scale5
                            ms-2">*</span></label>
                            <input type="text" class="form-control solid" name="mock_type" readonly>
                            <input type="hidden" name="mock_id">
                        </div>
                        <div class="col-xl-12 mb-4">
...
{{--New Student Mock--}}
<div class="modal fade" id="new-student-mock-modal">
    <form method="post" id="new-student-mock-form">
        @csrf
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">New Student Mock Exams</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <div class="modal-body">
...
<div class="modal fade" id="insert-student-mock-modal">
    <form method="post" id="insert-student-mock-form">
        @csrf
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Student Mock Exams Entry</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <h4 class="text-primary">Mock Calendar</h4>
                        <div class="col-xl-4 mb-4">
                            <label  class="form-label font-w600">Mock<span class="text-danger scale5
                            ms-2">*</span></label>
                            <input class="form-control solid" name="mock" type="text" readonly>
                            <input type="hidden" name="mock_id">
                        </div>
                        <div class="col-xl-4 mb-4">
