     ...
     $(document).ready(() => {
         ...
         $("#new-level-assessment-form select[name=level]").on("change", (e) => {
             ...
             $.ajax({
                 ...
                 success: (Response) => {
                     $("#new-level-assessment-modal").find("select[name=student]").html(
                         Response)
                 }
             })
         })
                 ...
                 success: (Response) => {
                     ...
                     $.each(Response, (key, value) => {
                         $("#new-level-assessment-modal").find(
                             ...
                             value['subject_id'] + '>' + value['subject'][
                                 'subject_name'
                             ] + '</option>')
                     })
             ...
             $.ajax({
                 ...
                 success: (Response) => {
                     ...
                     if (DecodedResults.status === 201) {
                         ...
                         $("#insert-level-assessment-modal").find('input[name=student_id]')
                             .val(Response['student']['student_id'])
                         $("#insert-level-assessment-modal").find('input[name=studentId]')
                             .val(Response['student']['id'])
                         $("#insert-level-assessment-modal").find('input[name=student_name]')
                         ...
                         $("#insert-level-assessment-modal").find(
                             'input[name=student_gender]').val(Response['student'][
                             'student_gender'
                         ])
                         $("#insert-level-assessment-modal").find(
                             'input[name=student_level]').val(Response['student'][
                             'level'
                         ]['level_name'])
                         $("#insert-level-assessment-modal").find('input[name=level_id]')
                             .val(Response['student']['student_level'])
                         $("#insert-level-assessment-modal").find(
                             'input[name=student_residency]').val(Response['student'][
                         ...
                         $("#insert-level-assessment-modal").find('input[name=term_id]').val(
                             Response['term']['id'])
                         $("#insert-level-assessment-modal").find(
                             'input[name=academic_year]').val(Response['term'][
                             'academic_year'
                         ]['academic_year_start'] + '/' + Response['term'][
                             'academic_year' +
                             ''
                         ]['academic_year_end'])
                         $("#insert-level-assessment-modal").find(
                             'input[name=academic_year_id]').val(Response['term'][
                             'term_academic_year'
                         ])
                         $("#insert-level-assessment-modal").find('input[name=branch_id]')
                             .val(Response['student']['student_branch'])
                         $("#insert-level-assessment-modal").find('input[name=subject]').val(
                             Response['subject']['subject_name'])
                         $("#insert-level-assessment-modal").find('input[name=subject_id]')
                             .val(Response['subject']['id'])
                     }
