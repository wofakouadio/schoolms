...
@section('content')
    ...
    {{--Modals--}}
    @push('modals')
        @include('admin/dashboard/assessment/level/Modals')
    @endpush
@endsection
{{--page js script--}}
@push('page-js')
...
@push('datatable')
    @include('admin/dashboard/assessment/level/DataTables')
@endpush
