                        ...
                        <div class="card-body">
                            ...
                            ms-2">*</span></label>
                                        <input type="text" class="form-control solid" name="student_name"
                                               value="{{$studentData->student_firstname .' '
                                                     ...
                                                     .$studentData->student_lastname}}" readonly>
                                    </div>
                                    <div class="col-xl-4 mb-4">
                            ...
                            ms-2">*</span></label>
                                        ...
                                        <input type="hidden" name="level_id"
                                               value="{{$studentData->student_level}}">
                                    </div>
                                    <div class="col-xl-4 mb-4">
                                        <label  class="form-label font-w600">Residency<span class="text-danger scale5
                            ms-2">*</span></label>
                                        <input class="form-control solid" name="student_residency"
                                               type="text" value="{{$studentData->student_residency_type}}"
                                               readonly>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            ms-2">*</span></label>
                                        ...
                                        <input type="hidden" name="term_id"
                                               value="{{$academicYearSession->id}}">
                                    </div>
                                    <div class="col-xl-6 mb-4">
                                        <label  class="form-label font-w600">Academic Year<span class="text-danger scale5
                            ms-2">*</span></label>
                                        <input class="form-control solid" name="academic_year_name"
                                               type="text"
                                            ...
                                            @foreach($studentClassAssessment as $key => $subject)
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" name="end_term[{{$key}}][class_score]"
                                                           class="form-control solid" value="{{$classScore}}"
                                                           readonly>
                                                    <label  class="form-label font-w600">Exam Score</label>
                                                    <input type="text" name="end_term[{{$key}}][exam_score]"
