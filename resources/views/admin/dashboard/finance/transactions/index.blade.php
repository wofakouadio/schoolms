                                                ...
                                                <li>
                                                    <div class="row">
                                                        <div class="col-3">
                                                            ...
                                                            <input value="{{ $value->invoice_id }}" name="fc[{{ $key }}][invoice_number]" class="form-control solid mb-4" readonly>
                                                        </div>
                                                        <div class="col-2">
                                                            <label>Item</label>
                                                            <input value="{{ $value->description }}" name="fc[{{ $key }}][item]" class="form-control solid mb-4" readonly>
                                                        </div>
                                                        <div class="col-2">
                                                            <label>Amount Due</label>
                                                            <input type="text" name="fc[{{ $key }}][amount_due]" class="form-control solid mb-4" readonly value="{{ $value->amount_due }}">
                                                        </div>
                                                        <div class="col-2">
                                                            <label>Amount to allocate</label>
                                                            <input type="number" name="fc[{{ $key }}][amount_to_pay]" class="form-control solid mb-4 amount_to_pay" id="amount_to_pay">
                                                        </div>
                                                        <div class="col-3">
                                                            <label>Transaction ID/Reference</label>
                                                            <input type="number" name="fc[{{ $key }}][transaction_id]" class="form-control solid mb-4">
                                                        </div>
                                                    </div>
                                                </li>
                                            @endforeach
